    ...
    <>
      <div className="min-h-screen bg-sp-bg text-sp-text pb-28 px-5 pt-6 space-y-8">
        ...
        <button
          ...
          className="w-full bg-sp-accent text-sp-bg font-barlow font-extrabold text-lg tracking-widest uppercase py-4 rounded-2xl transition-opacity hover:opacity-85 active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed"
        >
