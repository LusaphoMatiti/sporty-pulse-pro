...
// Returns the current progression state for a PlanInstance.
// Used by the progress dashboard and session screen.
...
// ─────────────────────────────────────────────
// UTILITY: buildNextMilestone
// Tells the user what they're working toward.
// Shown in the Progress screen progression card.
// ─────────────────────────────────────────────
...
function buildNextMilestone(
  ...
  switch (progressionType) {
    case "VOLUME":
      ...
      if (week < 4) return `Complete week 4 to unlock +1 set + reps`;
    ...
    case "DENSITY":
      ...
      return `${rest - 10}s rest target — reduce by 10s next phase`;
